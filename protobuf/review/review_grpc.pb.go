...
const (
	...
	ReviewService_GetBookWithReviews_FullMethodName = "/review.ReviewService/GetBookWithReviews"
)
...
type ReviewServiceClient interface {
	...
	GetBookWithReviews(ctx context.Context, in *GetBookWithReviewsRequest, opts ...grpc.CallOption) (*GetBookWithReviewsResponse, error)
}
...
func (c *reviewServiceClient) GetBookWithReviews(ctx context.Context, in *GetBookWithReviewsRequest, opts ...grpc.CallOption) (*GetBookWithReviewsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(GetBookWithReviewsResponse)
	err := c.cc.Invoke(ctx, ReviewService_GetBookWithReviews_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ReviewServiceServer interface {
	...
	GetBookWithReviews(context.Context, *GetBookWithReviewsRequest) (*GetBookWithReviewsResponse, error)
...
func (UnimplementedReviewServiceServer) GetBookWithReviews(context.Context, *GetBookWithReviewsRequest) (*GetBookWithReviewsResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method GetBookWithReviews not implemented")
}
...
func _ReviewService_GetBookWithReviews_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(GetBookWithReviewsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ReviewServiceServer).GetBookWithReviews(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: ReviewService_GetBookWithReviews_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ReviewServiceServer).GetBookWithReviews(ctx, req.(*GetBookWithReviewsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var ReviewService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "GetBookWithReviews",
			Handler:    _ReviewService_GetBookWithReviews_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "protobuf/review/review.proto",
}
